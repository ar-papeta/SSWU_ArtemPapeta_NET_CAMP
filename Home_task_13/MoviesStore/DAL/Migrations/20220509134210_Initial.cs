    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Genres",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), "Artem Artemov" });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "Description", "ReleaseDate", "Title" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000031"), "Test 1 movie", new DateTime(2022, 5, 9, 16, 42, 10, 93, DateTimeKind.Local).AddTicks(5946), "Movie tite 1" });
