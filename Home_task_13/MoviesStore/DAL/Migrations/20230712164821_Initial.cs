    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), "Action", null });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "Description", "ReleaseDate", "Title" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000031"), "Test 1 movie", new DateTime(2023, 7, 12, 19, 48, 20, 822, DateTimeKind.Local).AddTicks(6458), "Movie tite 1" });
